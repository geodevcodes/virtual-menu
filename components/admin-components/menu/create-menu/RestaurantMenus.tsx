...
interface RestaurantMenusProps {
  ...
  setIsRestaurantOpen: React.Dispatch<React.SetStateAction<boolean>>;
  register: any;
  errors: any;
}
...
export default function RestaurantMenus({
  ...
  const restaurantCategories = [
    { id: "foodMenuFile", label: "Food Menu" },
    { id: "drinkMenuFile", label: "Drink Menu" },
  ];
  ...
  return (
    <div className="mb-5 border-b border-gray-100 pb-3">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          type="button"
          onClick={() => setIsRestaurantOpen((s) => !s)}
        ...
        {isRestaurantOpen && (
          ...
          >
                    ...
                    {!file ? (
                      ...
                      >
                        {({
                          ...
                          <div
                            {...getRootProps()}
                            className={`flex items-center justify-center border-2 border-dashed rounded-lg p-6 text-center transition-colors cursor-pointer ${
            ...
            <div className="my-4">
              ...
              <input
                {...register("restaurantReviewLinkUrl")}
                type="text"
                ...
                className={`w-full py-3 px-4 text-sm text-[#667085] rounded-lg border bg-white ${
                  errors.restaurantReviewLinkUrl
                    ? "border-red-500"
                    : "border-gray-300"
                } outline-none`}
              />
              {errors.restaurantReviewLinkUrl && (
                <p className="text-red-500 text-xs mt-1">
                  {errors.restaurantReviewLinkUrl.message}
                </p>
              )}
              <Link
              ...
              >
                Create your survey in Incite360 <ChevronRight size={16} />
              </Link>
            </div>
          </motion.div>
        )}
